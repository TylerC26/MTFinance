      ...
      >
        <div className="relative">
          ...
          <Input
            ...
            inputMode="decimal"
            autoFocus
            className="h-20! border-0! bg-transparent! pl-12 font-mono text-6xl! font-semibold tabular-nums shadow-none! ring-0! focus-visible:border-0! focus-visible:ring-0! md:text-6xl!"
